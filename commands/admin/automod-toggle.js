...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(o => o.setName('rule-id').setDescription('Rule ID (from /automod-list)').setRequired(true))
        .addBooleanOption(o => o.setName('enabled').setDescription('Enable or disable the rule').setRequired(true)),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.editReply({ content: 'Failed to update the rule. Please try again.' });
        }
    },
};
